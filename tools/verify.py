...
PORT = 8110
PAGES = sys.argv[1:] or ["home.html", "orders.html", "planning.html", "allocation.html", "execution.html", "quality.html", "genealogy.html", "packing.html", "integration.html", "support.html", "index.html"]
...
try:
    ...
    with sync_playwright() as p:
        ...
        for page in PAGES:
            ...
            if page == "index.html":
                for pid in ["home", "orders", "planning", "allocation", "execution", "quality", "genealogy", "packing", "integration", "support"]:
